package com.gts.qrscanneralternative;
...
/**
 * QrScannerAlternativePlugin
 */
public class QrScannerAlternativePlugin implements MethodCallHandler, ActivityResultListener, StreamHandler, FlutterPlugin, ActivityAware {
    private static final String CHANNEL = "qr_scanner_alternative";

    private static FlutterActivity activity;
    private static Result pendingResult;
    private Map<String, Object> arguments;

    private static final String TAG = QrScannerAlternativePlugin.class.getSimpleName();
    ...
    public QrScannerAlternativePlugin() {
    }

    private QrScannerAlternativePlugin(FlutterActivity activity, final PluginRegistry.Registrar registrar) {
        QrScannerAlternativePlugin.activity = activity;
    }
    ...
    private void createPluginSetup(
        ...
        eventChannel =
                new EventChannel(messenger, "qr_scanner_alternative_receiver");
